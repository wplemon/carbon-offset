		...
		<div id="carbon-offset-sponsors">
			...
			<p>
				...
				printf(
					...
					esc_html__( 'This plugin cost you nothing, these amazing people and companies have already paid for it. Spread the %s and keep us going.', 'carbon-offset' ),
			...
			<p>
				<a href="https://github.com/sponsors/aristath" target="_blank" rel="nofollow">
					<?php esc_html_e( 'Pay it forward for the next people that will install & use it.', 'carbon-offset' ); ?>
				</a>
			</p>
